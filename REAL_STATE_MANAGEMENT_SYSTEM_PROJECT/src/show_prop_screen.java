 ...
 * @author admin
 */
public class show_prop_screen extends javax.swing.JFrame {

    /**
     * Creates new form SHOW_PROPERTIES_WINDOW
     */
    public show_prop_screen() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Description/Neighbourhood information:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(show_prop_screen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new show_prop_screen().setVisible(true);
            }
        });
    }
