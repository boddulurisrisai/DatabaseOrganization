 ...
 * @author admin
 */
public class regis_screen extends javax.swing.JFrame {
    ...
    private void jButton_LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LoginActionPerformed
        ...
        String selectquery = "INSERT INTO `users`(username,password) values(?,?)";
           ...
           password.trim().toLowerCase().equals("password"))
        {
            ...
            try {
                ...
                {
                	JOptionPane.showMessageDialog(null, "Please enter Valid details","Failed",2);
                }
                	
                
                login_screen mainform = new login_screen();
