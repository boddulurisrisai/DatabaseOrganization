 ...
 * @author admin
 */
public class prop_img_screen extends javax.swing.JFrame {

    /**
     * Creates new form prop_img_screen
     */
    ...
    private void jButton_Show_ImagesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Show_ImagesActionPerformed
        ...
        try
        {
            ...
            {
                  prop_img_slider_screen imagesSliderform = new prop_img_slider_screen(id);
    ...
    private void jButton_Remove_ImageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Remove_ImageActionPerformed
        ...
        if(yes_or_no == JOptionPane.YES_OPTION)
                {
                    if(new property_p().removePropertyImage(imageId))
                    {
    ...
    private void jComboBox_typesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox_typesActionPerformed
        ...
        property_p property = new property_p();
        ArrayList<property_p> propertyList = property.propertiesListByType(typeId);
    ...
    private void jList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList1MouseClicked
         ...
         try
        {
             String selectedListItem = String.valueOf(jList1.getSelectedValue());
            Integer imageId = Integer.valueOf(selectedListItem);
            byte[] image = new property_p().getImageById(imageId);
    ...
    {
        HashMap<byte[], Integer> imagesListMap = new property_p().propertyImagesList(propertyId);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(prop_img_screen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new prop_img_screen().setVisible(true);
            }
        });
    }
