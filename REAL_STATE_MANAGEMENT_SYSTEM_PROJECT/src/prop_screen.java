 ...
 * @author admin
 */
public class prop_screen extends javax.swing.JFrame {

    /**
     * Creates new form prop_screen
     */
    ...
    private void jButton_Edit_PropertyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Edit_PropertyActionPerformed
        ...
        { 
          ...
          property_p property = new property_p(id, type, squareFeet, ownerId, price, address, bedrooms, bathrooms, age, haveBalcony, havePool, haveBackyard, haveGarage, description);
          
          if(new property_p().editProperty(property))
          {
    ...
    private void jButton_Add_PropertyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Add_PropertyActionPerformed
        ...
        try
        {
          ...
          property_p property = new property_p(0, type, squareFeet, ownerId, price, address, bedrooms, bathrooms, age, haveBalcony, havePool, haveBackyard, haveGarage, description);
          
          if(new property_p().addNewProperty(property))
          {
    ...
    private void jButton_Show_PropertiesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Show_PropertiesActionPerformed
         ...
         show_prop_screen showPropertyForm = new show_prop_screen();
    ...
    private void jButton_Search_PropertyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Search_PropertyActionPerformed
        ...
        try{
            ...
            property_p property = new property_p().findProperty(propertyId);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(prop_screen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new prop_screen().setVisible(true);
            }
        });
    }
