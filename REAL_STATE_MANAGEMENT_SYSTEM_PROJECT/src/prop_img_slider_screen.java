 ...
 * @author admin
 */
public class prop_img_slider_screen extends javax.swing.JFrame {

    /**
     * Creates new form prop_img_slider_screen
     */
    ...
    public prop_img_slider_screen(int pId) {
        initComponents();
        ...
        jLabel_Previous.setBorder(jlabel_nav_border);
         ...
         HashMap<byte[], Integer> map = new property_p().propertyImagesList(propertyId);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(prop_img_slider_screen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new prop_img_slider_screen(propertyId).setVisible(true);
            }
        });
    }
