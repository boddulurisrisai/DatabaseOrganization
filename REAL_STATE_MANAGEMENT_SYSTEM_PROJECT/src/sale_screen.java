 ...
 * @author admin
 */
public class sale_screen extends javax.swing.JFrame {
    ...
    {
        property_p property = new property_p();
        ArrayList<property_p> propertyList = property.propertiesList();
    ...
    {
        sale_p sale = new sale_p();
        ArrayList<sale_p> salesList = sale.salesList();
    ...
    private void initComponents() {
        ...
        jTextField_FinalPrice1 = new javax.swing.JTextField();
        ...
        jTextField_FinalPrice1.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(54, 54, 54)
                                .addComponent(jTextField_FinalPrice1, javax.swing.GroupLayout.DEFAULT_SIZE, 102, Short.MAX_VALUE))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jTextField_FinalPrice1))
                        .addGap(65, 65, 65)
    ...
    private void jButton_Add_SaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Add_SaleActionPerformed
        ...
        try
        {
           ...
           // String sellingate = dateFormat.format(jTextField_FinalPrice1.getText());
            String sellingate = jTextField_FinalPrice1.getText();
            sale_p sale = new sale_p(0, propertyId, clientId, finalPrice, sellingate);

            if(new sale_p().addNewSale(sale))
            {
 ...
 try
       {
             ...
             //String sellingate = dateFormat.format(jTextField_FinalPrice1.getText());
             String sellingate = jTextField_FinalPrice1.getText();
             sale_p sale = new sale_p(id, propertyId, clientId, finalPrice, sellingate);

             if(new sale_p().editSale(sale))
             {
    ...
    private void jTable_SalesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_SalesMouseClicked
        ...
        try {
            ...
            jTextField_FinalPrice1.setText(""+jTable_Sales.getValueAt(selectedRowIndex, 4).toString());
            //jTextField_FinalPrice1.setText(""+saleDate);
        } catch (ParseException ex) {
            Logger.getLogger(sale_screen.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sale_screen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sale_screen().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jTextField_FinalPrice1;
