 ...
 * @author admin
 */
public class owner_screen extends javax.swing.JFrame {
    ...
    {
        owner_p owner = new owner_p();
        ArrayList<owner_p> ownersList = owner.ownersList();
    ...
    private void jButton_Add_OwnerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Add_OwnerActionPerformed
        ...
        {
            if(owner.addNewOwner(new owner_p(0, fname, lname, phone, email, address)))
            {
    ...
    private void jButton_Edit_OwnerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Edit_OwnerActionPerformed
        ...
        try{
            ...
            {
                if(owner.editOwnerData(new owner_p(ownerId, fname, lname, phone, email, address)))
                {
    ...
    private void jButton_Owner_PropertiesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Owner_PropertiesActionPerformed
        ...
        try
        {
            ...
            int id = Integer.valueOf(jTable1.getValueAt(selectedRowIndex, 0).toString());
             ...
             owner_property_screen ownerPropertiesform = new owner_property_screen(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(owner_screen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new owner_screen().setVisible(true);
            }
        });
    }
