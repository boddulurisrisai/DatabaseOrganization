 ...
 * @author admin
 */
public class screen_client extends javax.swing.JFrame {
    ...
    private void jButton_Add_ClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Add_ClientActionPerformed
        ...
        {
            if(client.addNewClient(new client_p(0, fname, lname, phone, email, address, "100")))
            {
    ...
    private void jButton_Edit_ClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Edit_ClientActionPerformed
        ...
        try{
            ...
            {
                if(client.editClientData(new client_p(clientId, fname, lname, phone, email, address, "100")))
                {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(screen_client.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
