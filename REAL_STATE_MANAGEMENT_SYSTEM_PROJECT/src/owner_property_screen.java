 ...
 * @author admin
 */
public class owner_property_screen extends javax.swing.JFrame {

    /**
     * Creates new form owner_property_screen
     */
    
    // the owner id
    static int ownerId;
    
    public owner_property_screen(int oId) {
        initComponents();
     ...
     public void fillJtableWithPropertiesData(int id)
    {
        ...
        ArrayList<property_p> propertyList = property.propertiesListByOwner(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(owner_property_screen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new owner_property_screen(ownerId).setVisible(true);
            }
        });
    }
